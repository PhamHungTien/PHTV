...
enum PHTVInputCodeTableLookup {
    ...
    static func findSourceKey(codeTable: Int32, character: UInt16) -> (keyCode: UInt32, variantIndex: Int32)? {
    ...
    static func characterForKey(codeTable: Int32, keyCode: UInt32, variantIndex: Int32) -> UInt16? {
        guard variantIndex >= 0 else { return nil }
        let table = codeTableLookup[clampedCodeTableIndex(codeTable)]
        guard let variants = table[keyCode], Int(variantIndex) < variants.count else { return nil }
        return variants[Int(variantIndex)]
    }

    private static func clampedCodeTableIndex(_ codeTable: Int32) -> Int {

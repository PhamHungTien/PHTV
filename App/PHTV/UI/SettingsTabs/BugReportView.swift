...
struct BugReportView: View {
    ...
    private func getBrowserDetectionInfo() -> String {
        ...
        output += "  - Auto English restore mode: \(appState.autoRestoreEnglishWordMode.reportLabel)\n"
    ...
    private func generateBugReportWithLogs(_ logs: String) -> String {
        ...
        if appState.includeSystemInfo {
            ...
            - **Auto restore English mode:** \(appState.autoRestoreEnglishWordMode.reportLabel)

...
*   **Fix #121 - Lệnh Terminal không hoạt động:** Khắc phục lỗi lệnh `clear`, `grep`, `printf` và các lệnh khác không hoạt động đúng trong Terminal khi bật chế độ tiếng Việt.
    ...
    *   Nguyên nhân 2: Khi "Tự động khôi phục tiếng Anh" bật và nhấn Enter, Terminal nhận Enter trước text.
    *   Giải pháp 2: Sử dụng step-by-step key sending cho auto English restore + Enter.

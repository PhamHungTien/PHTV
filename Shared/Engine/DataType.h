...
#if defined(PHTV_PLATFORM_LINUX) || defined(__linux__) || defined(LINUX)
#include "../Platforms/phtv_linux_keys.h"
#elif defined(_WIN32)
#include "../Platforms/phtv_windows_keys.h"
#else
#include "../Platforms/phtv_mac_keys.h"
#endif

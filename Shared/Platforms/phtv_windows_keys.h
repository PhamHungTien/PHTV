#ifndef PHTV_WINDOWS_H
#define PHTV_WINDOWS_H

// Internal engine key identifiers (platform-neutral values).
// Windows adapter layer maps Win32 scan/VK codes to these values.
#define KEY_ESC                                 53
